...
"|"+encodeURIComponent(b.category),0===b.priority?null!==g?(e("direct",a),e("remanent",g),f=g):(e("direct",a),p()):(null!==g&&(e("remanent",g),f=g),e("direct",a),p())):(h=l("xttvt").split("||"),a=h[0],f=h[1],e("direct",a),e("remanent",f));n("xttvt",(k(a)?a:"")+"||"+(k(f)?f:""),60*q);return d}(window.tvtrackingcustom,30,1);
