  ...
  function($,_, Backbone, sw, Handlebars, ItemsCollection, 
    ...
    var HomeView = Backbone.View.extend({
      ...
      initialize: function(options){
        ...
        this.whatsNewItems = new ItemsCollection({location:"www.olx.in", filters:"[{'name':'withPhotos', 'value':'true'}]"},{},{"item_type":"adsList"});
        this.whatsNewItems.on('sync',_.bind(this.items_success, this));
        this.whatsNewItems.fetch();

        this.lastVisitedItems = new ItemsCollection({location:"www.olx.in"},{},{"item_type":"adsList"});
        ...
        this.whatsNewItems = new collection([ {"id":"484949563", "title":"Chihuahua Puppies For Sale","thumbnail":"http://petliferadio.com/doggydog.jpg"},
