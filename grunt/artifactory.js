...
module.exports = function(grunt) {
    return {
        ...
        'dynamic': {
            files: [{
                src: ['app/**/*', '!app/config/default.js', '!app/config/build.js', 'node_modules/**/*', 'server/**/*', 'cache.js', 'memcached.js', 'appConf.js', 'bootstrap.js', 'cluster.js', 'index.js', 'newrelic.js', 'config.js', 'build.json'],
            }],
            options: {
                publish: [{
