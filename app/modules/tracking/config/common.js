...
module.exports = {
    pages: {
        ...
        'searchs#search': '[category-name]/[subcategory-id]/search/[page]?searchbox=[keyword]&section=[section]',
        'searchs#searchig': '[category-name]/[subcategory-id]/search/[page]?searchbox=[keyword]&section=[section]',
        'searchs#filter': '[category-name]/[subcategory-id]/search/[page]?searchbox=[keyword]&section=[section]',
        'searchs#filterig': '[category-name]/[subcategory-id]/search/[page]?searchbox=[keyword]&section=[section]',
        'searchs#statics': '[category-name]/[subcategory-id]/staticsearch/statickw_[keyword]',
        'searchs#allresults': '/nocat/listing/',
        'searchs#allresultsig': '/nocat/listing/',
